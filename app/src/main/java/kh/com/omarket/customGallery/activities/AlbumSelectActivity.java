...
import kh.com.omarket.customGallery.adapters.CustomAlbumSelectAdapter;
import kh.com.omarket.customGallery.models.AlbumImage;
import kh.com.omarket.R;

import static kh.com.omarket.R.anim.abc_fade_in;
import static kh.com.omarket.R.anim.abc_fade_out;

public class AlbumSelectActivity extends HelperActivity {

    private ArrayList<AlbumImage> albums;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstantsCustomGallery.limit = intent.getIntExtra(ConstantsCustomGallery.INTENT_EXTRA_LIMIT,
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case ConstantsCustomGallery.FETCH_COMPLETE: {
                        if (adapter == null) {
                            adapter = new CustomAlbumSelectAdapter(albums, getApplicationContext(),
    ...
    private class AlbumLoaderRunnable implements Runnable {
        ...
        public void run() {
            ...
            ArrayList<AlbumImage> temp = new ArrayList<>(cursor.getCount());
                ...
                do {
                    ...
                    if (!albumSet.contains(albumId)) {
                        ...
                        if (file.exists()) {
                            ...
                            temp.add(new AlbumImage(album, image));
            ...
            sendMessage(ConstantsCustomGallery.FETCH_COMPLETE);
        }
    }
